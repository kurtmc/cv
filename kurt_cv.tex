...
\begin{itemize} \itemsep -2pt % reduce space between items
    ...
    \item I worked on real world products at Vista. My changes where tested by quality assurance and merged to the main and release branches of the products.
\end{itemize}
