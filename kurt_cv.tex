...
\cventry{2021--2023}{Consultant}{Sourced Group}{Auckland}{}{
	\begin{itemize}
        \item Built out fully automated workflows using AWS CloudFormation,
            ...
            have them implemented across the platform within minutes
        \item Deploy workflows using best practice CI/CD platform using native
            AWS tools such as AWS CodePipeline and CodeBuild
        \item Improve code quality gates by building out automatic pull request
            validation steps in GitHub actions
