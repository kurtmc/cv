...
\quote{\small ``Most good programmers do programming not because they expect to get paid or get adulation by the public, but because it is fun to program.'' -- Linus Torvalds}                                 % optional, remove / comment the line if not wanted
...
\cventry{2014--present}{Android Developer}{Vista Entertainment Solutions}{Auckland}{}{Currently working as a part time Android developer on a consumer application that allows customers
...
\item highly experienced using the following tools for android development:
	...
	\item jenkins - continous integration server
...
\cvdoubleitem{Text editor}{vim}{Desktop environment}{KDE}
\cvdoubleitem{Web server}{apache}{Package manager}{zypper}
\cvdoubleitem{Init system}{systemd}{Distro}{OpenSuSe}

\section{Interests}
\cvitem{Hacking the Linux kernel}{Checkout my kernel module on \href{https://github.com/streetdragon/reverse_module}{gitub}}
\cvitem{Owning a motorcycle}{Cheapest way to park in town}
\cvitem{Mantaining linux servers}{I maintain an 8TB raid 6 file server at home}
...
\begin{cvcolumns}
  ...
  \cvcolumn{Name}{
    ...
    \item Darryl McLeod
    \end{itemize}}
  \cvcolumn[0.2]{}{Contact details provided on request}
\end{cvcolumns}
...
\newcommand{\companyName}{Company A}
\newcommand{\companyAddress}{Company, Inc.\\123 somestreet\\some city}
...
I would be very well suited to work for \companyName{} because I have experience that closely matches the sort of
products that \companyName{} maintains.
