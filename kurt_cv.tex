...
\cventry{2016--present}{Developer}{EROAD}{Auckland}{}{
	...
	\begin{itemize}
		\item Migrating old style deploys from Chef and Ansible to
			...
			request is merged
		\item Using AWS CloudFormation to build stacks that includeg EC2
			autoscaling groups, RDS, Kinesis Streams, Redis Caches,
			ELB's
		\item Using the AWS API to automate the cleanup of DNS resources
		...
		\item Using the AWS API to create a large pool of EC2 EBS
			...
			massively distrubed read only database.
